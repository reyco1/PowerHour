package com.reycogames.powerhour.model
{
	public class AppScreens
	{
		...
		public static const TAKE_PHOTO_OR_SKIP_SCREEN:String	= "take_photo_or_skip_screen";
		public static const TAKE_PHOTO_SCREEN:String			= "take_photo_screen";
		public static const CONFIRM_SNAPSHOT_SCREEN:String		= "confirm_snapshot_screen";
		public static const PROCESS_IMAGE_SCREEN:String			= "generate_gif_screen";
		public static const FINAL_SCREEN:String					= "final_screen";
		public static const HOW_TO_PLAY_SCREEN:String			= "how_to_play_screen";
	}
}